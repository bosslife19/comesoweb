...
const EmptyColorButton: React.FC<ButtonProps> = props => {
    ...
    const types = {
        ...
        primary: {
            __class: " my-3 border border-blue w-full text-blue text-md rounded-lg font-normal",
            text: "#fff",
        },
        secondary: {
    ...
    const __class = (() => {
        ...
        if (props.round)
            __base += " rounded-full w-full text-center";
        else __base += " " + base;
