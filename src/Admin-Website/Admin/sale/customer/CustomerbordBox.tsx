...
import BussinessChart from "../../../Charts/TopChart_line/BussinessChart";
import InvoicePd from "../../../Charts/TopChart_line/Paid_Invoices";
import SalesChart from "../../../Charts/TopChart_line/SalesChart";
import UnPdChart from "../../../Charts/TopChart_line/unPaid_Invoices";
...
const CustomerbordBox = () => {
  const chartData = [16, 15, 2, 47, 32, 14, 14, 55, 41, 69];
 
  return (
    <div className="flex justify-start  items-center gap-4 mb-4 flex-wrap">
      <ChartBox
...
export default CustomerbordBox;
