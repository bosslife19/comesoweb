...
export const HealthModal = ({ row, closeModal, handProceed }) => (
...
<div className="flex items-center border text-[12px] border-[#E5E7E8] text-[#959FA3] font-[400] md:text-[14px] leading-[20px] md:w-[292px] md:h-[40px] rounded-[4px]  px-5 pt-2 overflow-hidden gap-1">
  ...
  {/* {row.Timestamp} */}
        ...
        <div className="mt-4 flex justify-between">
          ...
          <button onClick={handProceed}   className="bg-[#0A2EE2] items-center flex gap-1 font-sans text-sm  text-white px-4 py-2 rounded-full font-[500]">Proceed
          <BsArrowRight/>
          </button>
        </div>
      </div>
